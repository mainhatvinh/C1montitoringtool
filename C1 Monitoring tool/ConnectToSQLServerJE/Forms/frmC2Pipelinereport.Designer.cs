...
{
	partial class frmC2Pipelinereport
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.grdPipeline.Location = new System.Drawing.Point(3, 40);
			this.grdPipeline.Name = "grdPipeline";
			this.grdPipeline.ReadOnly = true;
			this.grdPipeline.Size = new System.Drawing.Size(1162, 610);
			this.grdPipeline.TabIndex = 2;
			this.grdPipeline.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.GrdCRMCellDoubleClick);
			this.grdPipeline.DataBindingComplete += new System.Windows.Forms.DataGridViewBindingCompleteEventHandler(this.GrdCRMDataBindingComplete);
			// 
			// frmC2Pipelinereport
			// 
