...
namespace C1Monitoring
{
	...
	/// </summary>
	public partial class frmRevenueWeeklyReport : MyFormPage
	{
		BindingSource myBindingSource = new BindingSource();
		public frmRevenueWeeklyReport(int Role_type)
		{
			//
...
//			{
				...
				//myBindingSource = dcRevenue.GetAllWeekly(cmbYear.Text, dtpToDate.Text);
				DateTime date = FormatConverter.convertDateFromDBToCode(dtpToDate.Text);
				
				if (date.DayOfWeek != DayOfWeek.Friday && double.Parse(cmbYear.Text) < 2015)
				return;
				if (Validation.isYear1(cmbYear.Text) == false)
					return;
				dcRevenue.GetAllWeekly(cmbYear.Text, dtpToDate.Text);
				myBindingSource = dcRevenue.GetAllWeekly1();
				grdRevenue.DataSource =myBindingSource;
				grdRevenue.Columns["Total_Revenue"].DefaultCellStyle.Format ="#,##0";
				grdRevenue.Columns["Total_Revenue"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
				grdRevenue.Columns["Total_Hours"].DefaultCellStyle.Format ="#,##0";
				grdRevenue.Columns["Total_Hours"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
				grdRevenue.Columns["C1_Revenue"].DefaultCellStyle.Format ="#,##0";
				grdRevenue.Columns["C1_Revenue"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
				grdRevenue.Columns["C2_Revenue"].DefaultCellStyle.Format ="#,##0";
				grdRevenue.Columns["C2_Revenue"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
				grdRevenue.Columns["C1_Charged_Hours"].DefaultCellStyle.Format ="#,##0";
				grdRevenue.Columns["C1_Charged_Hours"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
				grdRevenue.Columns["C2_Charged_Hours"].DefaultCellStyle.Format ="#,##0";
				grdRevenue.Columns["C2_Charged_Hours"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
...
//				}
		...
		void CmbCaculateClick(object sender, EventArgs e)
		{
			DateTime date = FormatConverter.convertDateFromDBToCode(dtpToDate.Text);
			if (date.DayOfWeek != DayOfWeek.Friday)
				return;
			dcRevenue.CaculateWeekly(cmbYear.Text, dtpToDate.Text);
			MessageBox.Show("Caculate Successfully" );
		}
	}
}
